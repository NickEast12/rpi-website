  ...
  plugins: [
...

    {
      ...
      options: {
        ...
        policy: [
          // Block problematic scraping bots
          { userAgent: 'Spider/2.0', disallow: '/' },
          ...
          { userAgent: 'Apache-HttpClient', disallow: '/' },
          { userAgent: 'okhttp', disallow: '/' },
          { userAgent: 'PostmanRuntime', disallow: '/' },
          { userAgent: 'Insomnia', disallow: '/' },
